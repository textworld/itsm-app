...
import AdminInsuranceDictionaryPage from '../../../../src/views/AdminInsuranceDictionary/index.jsx';
...
export default async function Page() {
  ...
  if (!user) {
    redirect(getLoginRedirectHref('/dictionaries/insurance-types'));
  }
  ...
  return <AdminInsuranceDictionaryPage />;
}
