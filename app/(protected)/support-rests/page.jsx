...
import AdminSupportRestConfigPage from '../../../src/views/AdminSupportRestConfig/index.jsx';
...
export default async function Page() {
  ...
  if (!user) {
    redirect(getLoginRedirectHref('/support-rests'));
  }
  ...
  return <AdminSupportRestConfigPage />;
}
